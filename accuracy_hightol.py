...
output_df_result.to_csv('./matching_results_high_tolerance.csv', index=False, encoding='utf-8-sig')

# 計算高容忍度下的正確率
total_events = len(final_times)  # 總事件數（應偵測到的正確事件數）
accuracy = correct_matches / total_events * 100  # 正確率的計算
...
print('匹配結果已輸出至 matching_results_high_tolerance.csv')
